      ...
      componentToRender = (
        <div className="w-full pt-10 px-4 sm:px-6 md:px-8 lg:ps-72">
          <header>
            ...
            <h1 className="block text-2xl font-bold text-gray-800 sm:text-3xl">Application Layout: Sidebar Dark using Tailwind CSS</h1>
            ...
            <div className="mt-5 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
              <a className="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none" href="../examples.html">
        ...
        <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
          <ul className="space-y-1.5">
            <li>
              {/* Dashboard button */}
              <button
                className={`w-full flex items-center gap-x-3 py-2 px-2.5 text-sm rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-600 ${activeComponent === 'Dashboard' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white-300'}`}
